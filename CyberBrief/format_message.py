...
def format_webex(articles: list[dict], context_line: str) -> str:
    ...
    if _SHOW_LLM_NOTICE:
        lines += ["", "🤖 *Update: Summaries are now generated by GPT-4.1 via the Cisco AI platform.*"]
...
def format_telegram(articles: list[dict], context_line: str) -> str:
    ...
    if _SHOW_LLM_NOTICE:
        lines += ["", "🤖 <i>Update: Summaries are now generated by GPT-4.1 via the Cisco AI platform.</i>"]
